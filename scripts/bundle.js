...
(function() {
  var $, URI, format, setInitialWord, split, wordInput;
  ...
  setInitialWord = function(word) {
    var newUrl;
    newUrl = URI(window.location.href).query({
      initial: word
    });
...
},{"./phonic-splitter":4,"URIjs":7,"jquery":9}],2:[function(require,module,exports){
(function() {
  ...
  consonants = alphabet.filter(function(letter) {
...
(function() {
  ...
  createSimpleGrapheme = function(letters) {
    return {
      target: letters,
      replacement: [letters]
    };
  ...
  magicE = function(prefix) {
    var consonant, vowel;
    vowel = prefix[0], consonant = prefix[1];
    return {
  ...
  vowelsWithY = vowels.map(function(vowel) {
    return vowel + "y";
  });

  rBasedGraphemes = ["or", "ar", "er"];

  twoLetterGraphemes = ["ck", "ch", "dd", "ff", "ph", "gh", "gg", "ge", "ll", "le", "mm", "mb", "or", "ar", "er", "le", "sh", "ow", "nn", "kn", "pp", "rr", "wr", "ss", "ce", "se", "sc", "tt", "ve", "ve", "wh", "zz", "ze", "se", "sh", "ch", "si", "ti", "ch", "th", "ng"];
